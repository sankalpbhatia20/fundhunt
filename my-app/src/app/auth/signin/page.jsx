...
export default function SignInPage() {
  ...
  return (
    <>
      <Navbar />
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-white py-16">
            ...
            <Card className="max-w-md mx-auto shadow-xl border-0 bg-white/80 backdrop-blur-sm">
              ...
              <CardFooter className="flex flex-col space-y-4 border-t pt-6">
                <div className="text-sm text-center text-gray-500">
                  ...
                  <Button variant="link" className="p-0 font-semibold text-blue-600" onClick={() => router.push('/auth/signup')}>
                    Sign up
                  </Button>
                </div>
